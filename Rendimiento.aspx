<%@ Page Title="Pinturas Everest" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rendimiento.aspx.cs" Inherits="ReachSystem.Rendimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="baseform">
        <p><h2>ACTUALIZAR RENDIMIENTO</h2></p>
        ...
        <div class="fila col10L">
           ...
           <%-- <div class="fila col10L">
            ...
            <div class="fila col10L">
                <asp:Button class="botonsubmit" value="REGISTRARME" type="submit"  runat="server" CssClass="botonsubmit"  OnClick="Unnamed1_Click"  Text="ACTUALIZAR RENDIMIENTO"/>            
            </div>
        </div>
            <br />
            <br />     
