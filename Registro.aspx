...
<body>
    <form id="form1" runat="server">
         <nav class="nave fila col10L">
            <div class="col2L">
                <img id="logo" src="https://1.bp.blogspot.com/-oAR_y9q6oz4/YB0lahpi9QI/AAAAAAAAPns/YUOS2fnVuzM2kmAj6JidygqCXwYQnBcMQCLcBGAsYHQ/s2048/LOGO%2BNUEVO%2BEVEREST%2BOFICIAL.png"/>
            </div>                       
        </nav>
        <div class="subnave">
            </div>
        <div class="baseform">
            ...
            <div class="fila col10L">
                <input class="formulario" placeholder="Nombre (John)" id="Nombre" type="text" required runat="server"/>            
            </div>
            <div class="fila col10L">
                <input class="formulario" placeholder="Apellido (Pierce)" id="Text2" type="text" required runat="server"/>            
            </div>
            <%--<div class="fila col10L">
           ...
           <%-- <div class="fila col10L">
            ...
            <div class="fila col10L">
                <asp:Button class="botonsubmit" value="REGISTRARME" type="submit"  runat="server" CssClass="botonsubmit"  OnClick="Unnamed1_Click"  Text="REGISTRAR"/>            
            </div>
            <br />
            <br />
        </div>        
