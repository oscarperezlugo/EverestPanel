...
namespace ReachSystem
{
    public partial class CreacionUsuario : System.Web.UI.Page
    {
        ...
        {
            if (Nombre.Value.ToString() != null)
            {
                //string body = "<body>" +
                //    "<h1>COLOR AÑADIDO A WEB Y APP</h1>" +
                //    "</body>";
                ...
                //mail.Subject = "COLOR DISPONIBLE EN CARTA DE COLORES";
                ...
                {
                    string saveStaff = "INSERT into Colores (Categoria, Linea, Rendimiento, Nombre, Codigo, Presentacion, Color) VALUES (@Categoria, @Linea, @Rendimiento, @Nombre, @Codigo, @Presentacion, @Color)";
                    ...
                    using (SqlCommand querySaveStaff = new SqlCommand(saveStaff))
                    {
                        ...
                        querySaveStaff.Parameters.Add("@Rendimiento", SqlDbType.Float).Value = Double.Parse(Apellido.Value);
